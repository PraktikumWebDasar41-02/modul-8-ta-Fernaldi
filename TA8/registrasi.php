...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="password" class="form-control" id="inputPassword" name="repassword" placeholder="Re-Password">
    </div>
  </div>
  <div class="form-group">
    <label for="formGroupExampleInput" >&nbsp&nbsp&nbsp&nbspEmail</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="formGroupExampleInput" name="email" placeholder="Email@gmail.com">
    </div>
  <br>
